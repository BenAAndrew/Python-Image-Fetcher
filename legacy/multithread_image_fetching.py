from legacy.get_image_urls import get_image_urls
from legacy.validate_params import (
    validate_concurrent_images_download,
    validate_concurrent_image_search_params,
)
from legacy.download_images import get_existing_images
from legacy.download_image import download_image_simple_with_timeout
from legacy.download_page import download_page
from legacy.tools import print_summary
...
def concurrent_images_download(
    search_term,
    total_images,
    headers,
